...
# ---------- 환경 변수 설정 ----------
export FASTRTPS_DEFAULT_PROFILES_FILE=/home/aisl/data/git/metasejong/metacom2025/simulation_app/config/fastdds.xml
export ISAAC_SIM_PATH="/home/aisl/.local/share/ov/pkg/isaac-sim-4.2.0"
...
#   dongcheon   demo    gwanggaeto    jiphyeon      aicenter
...
# 추가 패키지 설치
${ISAAC_SIM_PATH}/python.sh -m pip install shapely svgwrite alphashape

# Python 스크립트 실행
${ISAAC_SIM_PATH}/python.sh simulation_app/codes/run_map_generator.py
